...
<body>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form-register" class="form-register form-horizontal"
						...
						<div class="form-group has-feedback">
							<input id="username" name="username" type="text"
								...
								data-placement="right" data-content="start"
								placeholder="Username" required autofocus> <span
								class="glyphicon form-control-feedback" id="username1"></span>
						</div>
						...
						<div class="form-group has-feedback">
							<input id="regemail" name="email" type="email"
								...
								class="glyphicon form-control-feedback" id="regemail1"></span>
						</div>
						...
						<div class="form-group has-feedback">
							<input id="regpassword" name="password" type="password"
								...
								class="glyphicon form-control-feedback" id="regpassword1"></span>
						</div>

						<div class="form-group has-feedback">
							<input id="regcpassword" name="cpassword" type="password"
								class="form-control" data-toggle="tooltip"
								data-placement="right" data-content="start"
								placeholder="Confirm Password" required> <span
								class="glyphicon form-control-feedback" id="regcpassword1"></span>
						</div>
	...
	<div class="container content">
		...
		<div class="row featurette">
			<div class="col-md-7">
				...
				<p class="lead">For the college student, their laptop is a tool for
					academic success, but it can be lost, misplaced, or stolen. Last
					Resort Recovery works to assist you in the recovery of your device.</p>
			</div>
			<div class="col-md-5">
		...
		<div class="row featurette">
			...
			<div class="col-md-7">
				...
				<p class="lead">An agent for a Linux based operating system will
					help you document your lost device so that assistance for recovery
					can begin right away.</p>
			</div>
		</div>
		...
		<div class="row featurette">
			<div class="col-md-7">
				<h2 class="featurette-heading">
					The Dashboard: <span class="text-muted">Quick and relevant
						information for you.</span>
				</h2>
				<p class="lead">Your dashboard will be personalized with the
					information from the agent and user registration to give clear and
					concise reports about the status of your lost device.</p>
			</div>
			<div class="col-md-5">
	...
	<script type="text/javascript"
		src="js/jquery-validate.bootstrap-tooltip.min.js" /></script>
