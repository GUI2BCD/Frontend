...
<body>
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <form id="login" class="navbar-form navbar-right"
                    role="form" action="login.php" method="post">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <form id="form-register"
                        ...
                        <h2 class="form-register-heading">Create your
                            account</h2>
                        ...
                        <div class="form-group has-feedback">
                            <input id="regpassword" name="password"
                                ...
                                class="glyphicon form-control-feedback"
                                id="regpassword1"></span>
                        </div>

                        <div class="form-group has-feedback">
                            <input id="regcpassword" name="cpassword"
                                type="password" class="form-control"
                                data-toggle="tooltip"
                                data-placement="right"
                                data-content="start"
        ...
        <div class="container">
            ...
            <p>
                <button class="btn btn-primary btn-lg"
                    data-toggle="modal" data-target="#RegisterForm">Sign
                    up</button>
            </p>
        </div>
    </div>
    ...
    <div class="container content">
        ...
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading">
                    Why Last Resort Recovery? <span class="text-muted">It'll
                        blow your mind.</span>
                </h2>
                <p class="lead">For the college student, their laptop is
                    a tool for academic success, but it can be lost,
                    misplaced, or stolen. Last Resort Recovery works to
                    assist you in the recovery of your device.</p>
            </div>
            <div class="col-md-5">
        ...
        <div class="row featurette">
            ...
            <div class="col-md-7">
                <h2 class="featurette-heading">
                    The Agent: <span class="text-muted">Your recovery
                        friend.</span>
                </h2>
                <p class="lead">An agent for a Linux based operating
                    system will help you document your lost device so
                    that assistance for recovery can begin right away.</p>
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading">
                    The Dashboard: <span class="text-muted">Quick and
                        relevant information for you.</span>
                </h2>
                <p class="lead">Your dashboard will be personalized with
                    the information from the agent and user registration
                    to give clear and concise reports about the status
                    of your lost device.</p>
            </div>
            <div class="col-md-5">
